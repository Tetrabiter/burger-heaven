            ...
            <div>
                ...
                <div>
                    <div className='w-full flex justify-center'>
                        <h1 className='w-2/3 text-[var(--color-white2)] text-3xl sm:text-4xl md:text-5xl lg:text-8xl font-extrabold text-center tracking-tighter'>NEW YORK’S FAVORITE ORGANIC HAMBURGER JOINT</h1>
                    </div>
                    <div className='-mt-[2%]'>
                ...
                <div id='about' className='bg-[var(--color-lime)] h-92 rounded-3xl'>
                    <div className='h-full flex justify-center items-center px-[5%] font-extrabold'>
                        <div className='w-3/5'>
                            <p className='w-3/4 text-3xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tighter'>THE BURGER ABOVE ALL BURGERS</p>
                        </div>
                        <div>
                ...
                <div id='menu' className="flex flex-col md:flex-row gap-8 mt-8 px-4">
                    {/* French Fries Card */}
                ...
                <div className='mt-[4%]'>
                    <marquee className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-secondary font-extrabold text-[var(--color-lime)] uppercase pb-[4%] tracking-tighter" behavior="" direction="">the best burger i’ve ever had</marquee>
                ...
                <div className='w-full h-48 my-[9%] flex justify-center items-center text-center text-[var(--color-white2)] font-extrabold'>
                    <div className='w-2/3 flex flex-col gap-6'>
                        <div className=''>
                            <h1 className='text-3xl sm:text-5xl md:text-6xl lg:text-7xl'>ORDER ONLINE OR COME VISIT US TODAY</h1>
                        </div>
                        <div>
